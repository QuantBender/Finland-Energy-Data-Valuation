...
IMPLEMENTED_ISO = ['PJM', 'FI', 'MISO', 'ISO-NE']
...
MONTHS['FI'] = collections.OrderedDict()
MONTHS['FI']['2021'] = [repr(n) for n in range(1, 13)]
MONTHS['FI']['2022'] = [repr(n) for n in range(1, 13)]
MONTHS['FI']['2023'] = [repr(n) for n in range(1, 13)]
MONTHS['FI']['2024'] = [repr(n) for n in range(1, 4)]
...
hist_data_dict['FI'] = {
    'CY 2013': gen_list('CY', 2013, 'FI'),
    'CY 2014': gen_list('CY', 2014, 'FI'),
    'CY 2015': gen_list('CY', 2015, 'FI'),
    'CY 2016': gen_list('CY', 2016, 'FI'),
    'CY 2017': gen_list('CY', 2017, 'FI'),
}
