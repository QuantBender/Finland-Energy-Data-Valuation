...
class AboutSelectionSummary(ModalView):
    ...
    def setisoinfo(self):
        ...
        if self.ISOselname == "NYISO":
            ...
            self.lab_abt_selsum.text = "The Electric Reliability Council of Texas (FI) manages the flow of electric power on the Texas Interconnection that supplies power to 24 million Texas customers - representing 85 percent of the state's electric load."
        elif self.ISOselname == "MISO":
