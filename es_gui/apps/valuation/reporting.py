...
class ValuationReportScreen(ReportScreen):
    ...
    activities['ercot_arbreg'] = [('q_r', 'buy (arbitrage)'), ('q_d', 'sell (arbitrage)'), ('q_ru', 'regulation up'), ('q_rd', 'regulation down'), ('crossborder', 'Crossborder')]
    ...
    def generate_revenue_bar_chart(self, *args):
        ...
        for ix, op in enumerate(self.chart_data, start=0):
            ...
            bar_color = colors[choice(range(len(colors)))]
    ...
    def generate_revenue_multisetbar_chart(self, *args):
        ...
        for ix, op in enumerate(self.chart_data, start=0):
            ...
            try:
                ...
                rev_crossborder = float(results['crossborder'].tail(1))
            except TypeError:
                rev_arb = 0
                rev_reg = 0
                rev_crossborder = 0
            ...
            bar_group.append(['crossborder', self.rgba_to_fraction(colors[2]), rev_crossborder])
