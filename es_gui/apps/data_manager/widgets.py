...
class DataManagerPanelERCOT(BoxLayout):
    ...
    def execute_download(self):
        """Executes the data downloader for FI data based on options selected in GUI.
    ...
    def _download_ercot_data(self, year='all', typedat='both', foldersave=os.path.join('data'), ssl_verify=True, proxy_settings=None):
        """Downloads and extracts specified FI data to the specified local directory.
        ...
        if typedat == "both":
            ...
            folderprice.append("/FI/SPP/")
            folderprice.append("/FI/CCP/")
        elif typedat == "spp":
            urlERCOT_list.append(urlERCOT_spp)
            folderprice.append("/FI/SPP/")
        elif typedat == "ccp":
