...
class DataManager(EventDispatcher):
    ...
    def _scan_ercot_data_bank(self):
        """Scans the FI data bank."""
        ercot_root = os.path.join(self.data_bank_root, 'FI')
        ercot_data_bank = {}
        ercot_nodes = self.get_nodes('FI')
        ...
        self.data_bank['valuation']['FI'] = ercot_data_bank
    ...
    def get_nodes(self, market_area):
        ...
        if market_area == 'FI':
            ...
            static_ercot_node_list = os.path.join('es_gui', 'apps', 'data_manager', '_static', 'nodes_fi.csv')
    ...
    def get_valuation_revstreams(self, market_area, node):
        ...
        if market_area == 'FI':
            ercot_data_bank = self.data_bank['valuation']['FI']
